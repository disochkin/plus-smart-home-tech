...
public class ErrorHandler {
    ...
    public ApiError handleNotFoundException(RuntimeException e) {
        ...
        return new ApiError(HttpStatus.NOT_FOUND, "Product not found", e.getMessage(), LocalDateTime.now().toString());
    }
    ...
    public ApiError handleBadRequestException(RuntimeException e) {
        ...
        return new ApiError(HttpStatus.BAD_REQUEST, "Bad request", e.getMessage(), LocalDateTime.now().toString());
    }
    ...
    public ApiError handleInternalServerError(Throwable e) {
        ...
        return new ApiError(HttpStatus.INTERNAL_SERVER_ERROR, "Internal server error", e.getMessage(), LocalDateTime.now().toString());
    }
}